...
circles = []
circles.append(Circle(10.0, name='black',x=60, y=150, x_vel=0,y_vel=10,color=(0,0,0)))

for i in range(1):
    circles.append(Circle(10.0, name='yellow',x=60*(i+1), y=250, x_vel=0,y_vel=5*(i+1),color=(255,255,128)))

circle1 = Circle(12.0, x=60*(i+1), y=50, x_vel=1,y_vel=2*(i+1),color=(256,0,0))
